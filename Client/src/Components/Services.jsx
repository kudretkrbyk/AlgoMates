  ...
  const services = [
    {
      ...
      description: 'Modern ve kullanıcı dostu arayüzler için AI destekli tasarım çözümleri',
      icon: '🎨',
      features: ['Responsive Tasarım', 'Kullanıcı Deneyimi Optimizasyonu', 'Modern UI/UX']
    },
    {
      title: 'Akıllı SEO Optimizasyonu',
      description: 'Yapay zeka ile güçlendirilmiş SEO stratejileri ve analizler',
      icon: '🔍',
      features: ['Anahtar Kelime Analizi', 'Rakip Analizi', 'Performans İzleme']
    },
    {
      title: 'Chatbot Entegrasyonu',
      description: '7/24 müşteri desteği sağlayan akıllı chatbot çözümleri',
      icon: '🤖',
      features: ['Doğal Dil İşleme', 'Çoklu Dil Desteği', 'Özelleştirilebilir Yanıtlar']
    },
    {
      title: 'Veri Analizi ve Raporlama',
      description: 'Kullanıcı davranışlarını analiz eden AI destekli raporlama sistemleri',
      icon: '📊',
      features: ['Gerçek Zamanlı Analiz', 'Özelleştirilebilir Raporlar', 'Tahminleme Modelleri']
    }
  ];
